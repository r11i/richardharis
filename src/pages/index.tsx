        ...
        <div className="container">
            ...
            <div className="textbanner">
                ...
                <div className="flex gap-3 mt-[10px] max-[480px]:block">
                  ...
                  <Link className="p-[10px] gap-2 flex justify-center items-center rounded-[14px] text-black bg-white max-[480px]:flex max-[480px]:mt-[20px] max-[480px]:w-[150px]" href={'https://drive.google.com/file/d/1H1N2ssZMrM0Y8qH6MBLHEFlWYBlCKuse/view?usp=sharing'}>
